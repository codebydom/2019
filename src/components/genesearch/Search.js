...
export class Search extends Component {
  ...
  build37(){
    ...
    document.getElementById("38").className="btn btn-secondary"
    b = "grch37."
  }
  build38(){
    document.getElementById("38").className="btn btn-primary active"
    document.getElementById("37").className="btn btn-secondary"
    b = "grch38."
  }
  getStyle(){
  ...
  handleSubmit(event) {
    ...
    if(this.state.value!==""){
      if (b===""){
        ...
        b=""
        var ajaxUrl = 'https://rest.ensembl.org/phenotype/term/homo_sapiens/'+this.state.value+'?content-type=application/json' 
      } else {
        var ajaxUrl = 'https://grch37.rest.ensembl.org/phenotype/term/homo_sapiens/'+this.state.value+'?content-type=application/json' 
      }
    ...
    <div id="center">
      ...
      <div className="input-group">
        ...
        <div className="btn-group" role="group" aria-label="Basic example">
            <button id="37" type="button" className="btn btn-primary active" onClick={this.build37} style={{textTransform:"initial"}}>GRCh37</button>
            <button id="38" type="button" className="btn btn-secondary" onClick={this.build38} style={{textTransform:"initial"}}>GRCh38</button>
        </div>
