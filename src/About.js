...
export const About = () => (
    ...
    <div className="container">
        ...
        <p>
            As my experience grows, so does code by dom, and even if I may not be able to update it accordingly to show all of my current software engineering expertise, I enjoy sharing the projects I can.
